...
`anshin.care` は、Anshin のサービス群を紹介するシンプルな SPA サイトです。システム開発支援、Anshin 本体、アンシン脆弱性診断、新サービス市場調査メモにある介護ロボット・介護テクノロジー構想を、短いキャッチアイと4つのサービス概要カードで伝えることを目的にします。
...
- 4カードは MUI Grid で、スマートフォン1列、タブレット2列、デスクトップ4列相当に並べる。
